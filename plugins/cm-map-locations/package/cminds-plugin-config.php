...
$cminds_plugin_config = array(
	...
	'plugin-addons'        => array(
		array(
			...
			'link' => 'https://www.cminds.com/store/maps-routes-manager-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1',
		...
		array(
			...
			'link' => 'https://www.cminds.com/store/purchase-cm-business-directory-plugin-for-wordpress?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1',
	...
	'plugin-store-url'			 => 'https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1',
	...
	'plugin-video-tutorials-url'		 => 'https://www.cminds.com/video-lesson/lesson/google-map-locations-plugin/',
            ...
            <div class="pricing-table" id="pricing-table"><h2 style="padding-left:10px;">Upgrade The Location Map Plugin:</h2>
                <ul>
                   ...
                   <hr>
                    ...
                    <hr>
                 <a href="https://www.cminds.com/wordpress-plugins-library/seo-keyword-hound-wordpress?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" target="blank"><img src="' . plugin_dir_url( __FILE__ ). 'views/Hound2.png"  width="220"></a><br><br><br>
                <a href="https://www.cminds.com/store/cm-wordpress-plugins-yearly-membership?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" target="blank"><img src="' . plugin_dir_url( __FILE__ ). 'views/banner_yearly-membership_220px.png"  width="220"></a><br>
	</ul>
	<ul>
        <li class="heading">Pro<a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
        <li class="price">$39.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
         <li class="action"><a href="https://www.cminds.com/?edd_action=add_to_cart&download_id=65188&edd_options[price_id]=1&utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
	...
	<ul>
        <li class="heading">Mapping Plugins Deluxe <a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
        <li class="price">$69.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
         <li class="action"><a href="https://www.cminds.com/?edd_action=add_to_cart&download_id=73574&edd_options[price_id]=1&utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
	...
	<ul>
        <li class="heading">Mapping Plugins Ultimate <a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="float:right;font-size:11px;color:white;" target="_blank">More</a></li>
        <li class="price">$119.00<br /> <span style="font-size:14px;">(For one Year / Site)<br />Additional pricing options available <a href="https://www.cminds.com/store/map-locations-plugin-for-wordpress-by-creativeminds?utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" target="_blank"> >>> </a></span> <br /></li>
         <li class="action"><a href="https://www.cminds.com/?edd_action=add_to_cart&download_id=174519&edd_options[price_id]=1&utm_source=locationfree&utm_campaign=freeupgrade&upgrade=1" style="font-size:18px;" target="_blank">Upgrade Now</a></li>
