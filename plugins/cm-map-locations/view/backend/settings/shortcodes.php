...
<?php if (App::isPro()): ?>
	...
	<li><kbd>[cmloc-locations-map list="one of: none left right bottom compact" limit=5 page=1 category="id or slug" mapwidth=pixels mapheight=pixels width=pixels]</kbd> - displays the locations map, optionally from chosen category and with the pagination.</li>
	...
	<li><kbd>[my-locations-table controls=1 addbtn=1]</kbd> - display the user's locations table</li>
<?php endif; ?>